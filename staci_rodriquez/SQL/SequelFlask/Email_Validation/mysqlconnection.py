...
#++++ first arguement is query and second is data
        result = self.db.session.execute(text(query), data)
#++++  The data being passed is in form of a dictionary 

#============   figuring out how it will run query   =============
...
#  this function return an instance of the class AKA module declaration